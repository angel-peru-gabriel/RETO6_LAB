...
HD_PWD='C:/Users/Aquino/Downloads/UTEC/CD_vivado/RETO_LAB06/RETO_LAB06.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_global.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_global.tcl
