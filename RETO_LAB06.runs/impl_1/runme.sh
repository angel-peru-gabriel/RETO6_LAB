...
HD_PWD='C:/Users/Aquino/Downloads/UTEC/CD_vivado/RETO_LAB06/RETO_LAB06.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_global.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_global.tcl -notrace
